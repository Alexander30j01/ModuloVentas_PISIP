...
public class VisitaRepositorioImpl implements IVisitaRepositorio {
	...
	public VisitaRepositorioImpl(IVisitaJpaRepositorio jpaRepositorio, IVisitaJpaMapper entityMapper) {
	...
	public Optional<Visita> buscarPorId(int idVisita) {
		return jpaRepositorio.findById(idVisita).map(entityMapper::toDominio);
	}
