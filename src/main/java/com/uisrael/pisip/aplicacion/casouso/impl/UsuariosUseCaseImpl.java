...
public class UsuariosUseCaseImpl implements IUsuariosUseCase {
	...
	@Override
	public Usuarios registrar(Usuarios nuevoUsuario) {
		nuevoUsuario.setActivo(true);
		nuevoUsuario.setNumeroVisitas(0);
	...
	public Usuarios buscarPorId(int idUsuarios) {
		return repositorio.buscarPorId(idUsuarios).orElseThrow(() -> new RuntimeException("Usuario no encontrado"));
	}
